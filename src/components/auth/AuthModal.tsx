      ...
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-floating border border-slate-200 overflow-hidden">
        ...
        <div className="p-6 bg-slate-950 text-white flex items-start justify-between border-b border-slate-800 relative">
          <div className="flex items-center space-x-4">
            <div className="w-14 h-14 rounded-2xl bg-white/10 border border-white/15 p-2 flex items-center justify-center shadow-lg backdrop-blur-xs shrink-0">
              <img
            ...
            <div>
              <span className="text-[11px] font-extrabold uppercase tracking-widest text-[#D89947]">NYAYAI Secure Portal</span>
